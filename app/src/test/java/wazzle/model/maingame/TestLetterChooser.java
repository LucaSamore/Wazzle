...
public class TestLetterChooser {
  ...
  public void testChooser4x4() {
    EnumMap<Range, WeightedAlphabet> classifiedLetters =
        new EnumMap<Range, WeightedAlphabet>(
            Map.of(
                ...
                Range.MEDIUM_FREQUENCY,
                    new WeightedAlphabetImpl(Map.of('C', 15.0, 'T', 11.0, 'R', 10.0)),
                Range.LOW_FREQUENCY,
                    new WeightedAlphabetImpl(Map.of('L', 9.0, 'M', 8.0, 'P', 6.0))));
    LetterChooser letterChooser = new LetterChooserImpl(classifiedLetters, new Pair<>(4, 4), null);
    // EnumMap<Range, List<Pair<Character, Double>>> choosenLetters =
    // letterChooser.chooseForTests();
