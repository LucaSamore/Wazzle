...
import wazzle.model.maingame.letter.LetterImpl;
import wazzle.model.maingame.letter.Range;

public class TestLetterAllocator {

  @Test
  public void testGridChecker() {
    EnumMap<Range, List<Pair<Character, Double>>> choosenLetters16 =
        new EnumMap<Range, List<Pair<Character, Double>>>(
            Map.of(
    ...
    Set<Letter> allocatedLettersCorrectly =
        new HashSet<>(
            Set.of(
                new LetterImpl(new Pair<>(0, 0), 'A', 2),
                new LetterImpl(new Pair<>(0, 1), 'E', 2),
                new LetterImpl(new Pair<>(0, 2), 'C', 2),
                new LetterImpl(new Pair<>(0, 3), 'N', 2),
                new LetterImpl(new Pair<>(1, 0), 'I', 2),
                new LetterImpl(new Pair<>(1, 1), 'T', 2),
                new LetterImpl(new Pair<>(1, 2), 'O', 2),
                new LetterImpl(new Pair<>(1, 3), 'S', 2),
                new LetterImpl(new Pair<>(2, 0), 'X', 2),
                new LetterImpl(new Pair<>(2, 1), 'I', 2),
                new LetterImpl(new Pair<>(2, 2), 'R', 2),
                new LetterImpl(new Pair<>(2, 3), 'O', 2),
                new LetterImpl(new Pair<>(3, 0), 'R', 2),
                new LetterImpl(new Pair<>(3, 1), 'Z', 2),
                new LetterImpl(new Pair<>(3, 2), 'E', 2),
                new LetterImpl(new Pair<>(3, 3), 'A', 2)));
    assertTrue(letterAllocator16.checkGridForTests(allocatedLettersCorrectly));

    Set<Letter> allocatedLettersWrongly =
        new HashSet<>(
            Set.of(
                new LetterImpl(new Pair<>(0, 0), 'A', 2),
                new LetterImpl(new Pair<>(0, 1), 'E', 2),
                new LetterImpl(new Pair<>(0, 2), 'I', 2),
                new LetterImpl(new Pair<>(0, 3), 'O', 2),
                new LetterImpl(new Pair<>(1, 0), 'I', 2),
                new LetterImpl(new Pair<>(1, 1), 'T', 2),
                new LetterImpl(new Pair<>(1, 2), 'C', 2),
                new LetterImpl(new Pair<>(1, 3), 'S', 2),
                new LetterImpl(new Pair<>(2, 0), 'X', 2),
                new LetterImpl(new Pair<>(2, 1), 'N', 2),
                new LetterImpl(new Pair<>(2, 2), 'R', 2),
                new LetterImpl(new Pair<>(2, 3), 'O', 2),
                new LetterImpl(new Pair<>(3, 0), 'R', 2),
                new LetterImpl(new Pair<>(3, 1), 'Z', 2),
  ...
  public void testAllocator4x4() {
    ...
    choosenLetters16.values().stream()
        .forEach(
            c ->
                startingLetters16.addAll(
                    c.stream().map(l -> l.getKey()).collect(Collectors.toList())));
    LetterAllocator letterAllocator16 = new LetterAllocatorImpl(choosenLetters16, null);
  ...
  public void testAllocator5x5() {
    ...
    EnumMap<Range, List<Pair<Character, Double>>> choosenLetters25 =
        new EnumMap<Range, List<Pair<Character, Double>>>(
            Map.of(
                Range.HIGH_FREQUENCY,
                List.of(
  ...
  public void testAllocator6x6() {
    EnumMap<Range, List<Pair<Character, Double>>> choosenLetters36 =
        new EnumMap<Range, List<Pair<Character, Double>>>(
            Map.of(
                Range.HIGH_FREQUENCY,
                List.of(
