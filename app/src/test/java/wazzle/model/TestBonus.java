...
public class TestBonus {
  ...
  public void testBonus() {
    ...
    assertTrue(
        bonusManager.applyScoreBonus(currentScore, gridTotalScore)
            == currentScore + gridTotalScore);
    ...
    // Extract
    int startQuantity =
        bonusManager.getScoreBonusQuantity()
            + bonusManager.getWordBonusQuantity()
