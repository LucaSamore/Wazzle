...
public class TestDictionaryImpl {
  ...
  /**
   * The private method "setDictionary" opens a stream while reading the file, the stream in then
   * collected in to a Set. If the file is not present, or cannot be read, it throws an exception.
   *
   * @param fileName The name or the relative path of the file you are trying to open. All the words
   *     in the file must be separated with a end-of-line character.
   * @return
   */
  @Test
