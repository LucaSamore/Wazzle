...
/**
 * This class is a concrete implementation for {@link WazzleController} It provides methods for
 * manage every Wazzle component.
 */
public final class WazzleControllerImpl implements WazzleController {
  ...
  public WazzleControllerImpl() throws IOException {
    ...
    this.settingsController =
        new SettingsControllerImpl(this.difficultiesFromFIle(), this.currentDifficultyFromFile());
  ...
  /** {@inheritDoc} */
  @Override
  public MainGame startNewMainGame(
      Dictionary dataset, Pair<Integer, Integer> gridShape, Difficulty difficulty) {
  ...
  public void saveCurrentDifficulty() throws IOException {
    this.fileController.saveCurrentSettings(
        WazzleFiles.SETTINGS.getFileName(), this.getCurrentDifficulty());
  }

  /** {@inheritDoc} */
  @Override
  public void saveGameHistory() throws IOException {
    this.fileController.saveGames(
        WazzleFiles.HISTORY.getFileName(),
        this.getGameHistory().stream()
