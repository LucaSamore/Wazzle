...
/** This enum groups all files used in Wazzle and provides a method for obtaining them. */
public enum WazzleFiles {
  ...
  private static final String DIRECTORY =
      System.getProperty("user.home") + SEPARATOR + "wazzle" + SEPARATOR + "files" + SEPARATOR;
