...
public interface MiniGameController {
  ...
  /**
   * If it's present, this method loads a previous saved minigame, if not it starts a new one.
   *
   * @throws IOException Signals that an I/O exception has occurred.
  ...
  /**
   * Check if game is won an return an Optional, if the optional is empty, it means that the game is
   * lost and therefore no bonus has been obtained.
   *
   * @return name - the name of the obtained bonus if present, and empty optional if the game is
   *     lost. if the optional is empty, it means that the game is lost and therefore no bonus has
   *     been obtained.
   * @throws IOException Signals that an I/O exception has occurred.
   */
  ...
  /**
   * Given an index, this method returns the corresponding result code of the letter contained in
  ...
  /**
   * Given an index, this method returns the corresponding letter contained in the last inserted
   * word.
   *
   * @see Result
   * @param index - index of the letter you want to know the result of
