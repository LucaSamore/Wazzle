 ...
 * It provides methods for handling every state of the game and gain information about it.
 */
public interface MainGameController {
	 ...
	 * @return {@code true} if {@link MainGame#getFailedAttempts()} equals a certain number, {@code false} otherwise.
	 */
	boolean needHelp();
	
	/**
	 * This method checks if the game is over.
	 * @return {@code true} if {@link MainGame#wordsFound()} == {@link MainGame#wordsCanBeFound()}, {@code false} otherwise.
	 */
	boolean areWeDone();
