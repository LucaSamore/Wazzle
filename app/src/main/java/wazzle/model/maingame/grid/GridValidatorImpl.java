...
/**
 * This class is an implementation for {@link wazzle.model.maingame.grid.GridValidator}.
 * It uses {@link wazzle.model.maingame.grid.Filters} in order to perform a quality check on the provided {@code Set<Letter>}.
 * 
