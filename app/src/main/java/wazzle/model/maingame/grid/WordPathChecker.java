...
/**
 * This class provides an algorithm for searching a {@code String} inside a {@code Map<Pair<Integer,
 * Integer>, Character>}. This class is used by {@link Filters#checkPath(String, java.util.Set)} All
 * credits for this implementation go to <i>jump1221</i> (thank you buddy):
 *
...
public final class WordPathChecker {
  ...
  private boolean search(
      final Map<Pair<Integer, Integer>, Character> board,
      final String word,
      final int i,
      final int j,
      final int index) {
