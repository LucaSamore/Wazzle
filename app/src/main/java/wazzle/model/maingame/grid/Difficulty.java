 ...
 * More precisely, it encapsulates all the parameters used for improving the difficulty of a {@link wazzle.model.maingame.grid.Grid}.
 * It also provides a default configuration via {@link wazzle.model.maingame.grid.Difficulty#getDefault()}
 */
public final class Difficulty {
	 ...
	 * 						 This name comes from {@link wazzle.model.maingame.grid.DifficultyNames}.
