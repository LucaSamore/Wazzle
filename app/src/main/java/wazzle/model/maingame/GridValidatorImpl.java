...
/**
 * This class is an implementation for {@link wazzle.model.maingame.GridValidator}.
 * It uses {@link wazzle.model.maingame.Filters} in order to perform a quality check on the provided {@code Set<Letter>}.
 * 
 * @see wazzle.model.maingame.Filters
...
public final class GridValidatorImpl implements GridValidator {
	...
	public Optional<Set<String>> validate(final Set<Letter> letters) {
		return this.qualityCheck(this.dataset.getWords()
				.stream()
