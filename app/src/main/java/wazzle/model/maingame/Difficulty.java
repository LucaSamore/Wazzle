...
/**
 * This class represents a configuration for {@link wazzle.model.maingame.MainGame} difficulty.
 * More precisely, it encapsulates all the parameters used for improving the difficulty of a {@link wazzle.model.maingame.Grid}.
 * It also provides a default configuration via {@link wazzle.model.maingame.Difficulty#getDefault()}
 */
public final class Difficulty {
	 ...
	 * @param difficultyName a {@code String} which represents the name of this difficulty configuration. 
	 * 						 This name comes from {@link wazzle.model.maingame.DifficultyNames}.
	 * @param gridShape an integer describing the shape of the {@link wazzle.model.maingame.Grid}
	...
	public static Difficulty getDefault() {
		return new Difficulty(DEFAULT_NAME, DEFAULT_SHAPE, DEFAULT_LOWER_BOUND, DEFAULT_UPPER_BOUND, DEFAULT_TIME);
	}
