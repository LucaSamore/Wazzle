...
public interface LetterChooser {
	...
	/**
	 * Choose the Character that have to populate the grid. The criterion on choice of 
	 ...
	 * The result of the choice is passed to the notifyFromChooser Mediator method.
	 */
	public void choose();
	 ...
	 * Choose the Character that have to populate the grid. The criterion on choice of 
	 * the Characters is that the grid have to contain a number of Character for every
	 * Range proportionally to the weight of every Range, but it doesn't use a Mediator. 
