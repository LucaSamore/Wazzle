...
/**
 * This interface is an API for managing the Mini game flow. It provides methods
 * for gaining information about the state of the minigame.
 */
...
public interface MiniGame {
    ...
    /**
     * Given a string containing the word inserted by the user, returns the
     * corresponding computed word.
     *
