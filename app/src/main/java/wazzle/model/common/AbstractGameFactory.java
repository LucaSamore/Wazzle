...
/**
 * Represents an abstract factory that is responsible of the creation of {@code MainGame} and {@code
 * MiniGame} objects. More formally, it provides a set of methods for creating different game
 * objects.
 *
...
public interface AbstractGameFactory {
   ...
   *
   * @param dataset a {@code Dictionary} object that represents what dataset the game is going to
   *     use
