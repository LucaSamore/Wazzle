...
public final class TutorialMiniGameView extends View<WazzleController> {
  ...
  protected void setGraphics() {
    ...
    final var textFontSize =
        Bindings.concat("-fx-font-size: ", visualUnit.multiply(0.025).asString(), ";");
    final var paddingValue =
        Bindings.concat("-fx-padding: ", visualUnit.multiply(0.05).asString(), ";");
    final var spacingValue =
        Bindings.concat("-fx-spacing: ", visualUnit.multiply(0.02).asString(), ";");
  ...
  private void writeTutorialToLabel() {
    this.textArea.setText(
        "Lo scopo del gioco e' quello di indovinare la parola nascosta in sei tentativi. Inizia "
