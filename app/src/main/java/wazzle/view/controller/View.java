...
/**
 * This class represents an abstraction for view objects.
 * It provides a set of abstract methods for set up the graphics elements, build the actual view
 * and switch to the next view.
