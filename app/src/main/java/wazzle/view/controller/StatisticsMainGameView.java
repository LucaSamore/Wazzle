...
public final class StatisticsMainGameView extends View<MainGameController> {
  ...
  @FXML private Label wordsFoundLabel;

  @FXML private Label wordsFoundValueLabel;

  @FXML private Label separatorWordLabel;

  @FXML private Label totalWordsValueLabel;

  @FXML private Label pointsLabel;

  @FXML private Label pointsValueLabel;

  @FXML private Label longestWordFoundLabel;

  @FXML private Label longestWordFoundValueLabel;

  @FXML private Label mostValuableWordLabel;

  @FXML private Label mostValuableWordValueLabel;
  ...
  protected void setGraphics() {
    ...
    this.wordsFoundValueLabel.setText(
        "" + (int) this.controller.getGame().get().wordsFound().size());
    this.totalWordsValueLabel.setText(
        "" + (int) this.controller.getGame().get().wordsToBeFound().size());
