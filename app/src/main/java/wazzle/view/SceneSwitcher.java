...
/**
 * This interface provides static methods for switching a scene. 
 * The switch can happen after an {@link ActionEvent} has occurred.
 * This interface uses {@link Loader} for loading the next scene.
 */
public interface SceneSwitcher {
	...
	/**
	 * Switches to a different scene given an {@link Stage}, the controller for the next view 
	 * and the path to the FXML file of the next view.
